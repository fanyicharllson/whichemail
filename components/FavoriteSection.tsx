...
export const FavoritesSection: React.FC<FavoritesSectionProps> = ({ services }) => {
    ...
    return (
        <View className="px-6 mb-6">
                        ...
                        >
                            ...
                            <View className="flex-row gap-2">
                                ...
                                {service.hasPassword ? (
                                    ...
                                    <View className="flex-1 bg-slate-100 dark:bg-slate-700 py-2.5 rounded-lg flex-row items-center justify-center gap-1.5">
                                        <Ionicons name="lock-open-outline" size={14} color={isDark ? '#94a3b8' : '#64748b'} />
                            ...
                            {service.website && (
                                <View className="mt-2 flex-row items-center gap-1.5">
                                    <Ionicons name="globe-outline" size={12} color={isDark ? '#94a3b8' : '#64748b'} />
                                    <Text 
            ...
            <View className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-3 mt-4 flex-row items-start gap-2 border border-amber-200 dark:border-amber-800">
                <Ionicons name="star-outline" size={16} color="#f59e0b" style={{ marginTop: 2 }} />
                <Text className="text-amber-700 dark:text-amber-300 text-xs flex-1 leading-5">
                    Star your most-used services for quick access! Tap the ⭐ on any service.
                </Text>
            </View>
        </View>
    );
